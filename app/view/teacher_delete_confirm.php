	...
	<div class="container">
		<form action="" method="POST">
			<div class="form_title">
				<span><?php echo "XÁC NHẬN XÓA THÔNG TIN GIÁO VIÊN"?></span>
			</div>
			<div class="form">
				<div class="form_item">
				...
				<div class="form_item">
					...
					<div class="form_item_information">
						<span><?php echo getSubjectName($teacher['subject_id'])?></span>
					</div>
				</div>
				<div class="form_item">
					<div class="form_item_title">
					...
					<div class="form_item_information">
						<span><?php echo $teacher['degree']?></span>
					</div>
				</div>
				<div class="form_item">
					<div class="form_item_title">
					...
					<div class="form_item_information">
						<span><?php echo $teacher['description']?></span>
					</div>
				</div>
				<div class="form_item">
					<div class="form_item_title">
					...
					<div class="form_item_avatar">
						<img src="<?php echo '../../web/avatar/' . $teacher['avatar'] . ''?>">
					</div>
				</div>
			</div>
			<div class="buttons">
